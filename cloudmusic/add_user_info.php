 ...
 * @LastEditTime: 2021-12-03 03:36:30
...
if (!$isRepetion) {
    ...
    $insert_status_sql = "INSERT INTO user_status (uid, online, points, signIn) values (?, ?, ?, ?)";
    $stmt2 = mysqli_prepare($link, $insert_status_sql);
    mysqli_stmt_bind_param($stmt2, 'isis', $id, $online, $points, $signIn);
