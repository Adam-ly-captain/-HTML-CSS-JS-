 ...
 * @LastEditTime: 2021-10-18 14:22:23
...
module1.foo1();
var cellphone = document.getElementById("div1");
...
cellphone.onclick = function() {
    // checkCellphone(cellphone.innerHTML);
    // console.log(cellphone.innerHTML);
    module2.checkCellphone(cellphone.innerHTML, axios);
}

async function checkCellphone (telephone) {
...
// }
// export {a}
},{"./module1":3,"./module2":4,"npm/node_modules/axios":5}],3:[function(require,module,exports){
/*
 * @Author: AdamShyly
 * @LastEditors: AdamShyly
 * @Description: The night stars live at the top of the tower
 * @Date: 2021-10-17 15:53:55
 * @LastEditTime: 2021-10-18 01:03:37
 ...
 * @LastEditTime: 2021-10-18 14:23:40
...
},{"npm/node_modules/axios":5}],5:[function(require,module,exports){
...
},{"./adapters/http":6,"./adapters/xhr":6,"./core/enhanceError":16,"./helpers/normalizeHeaderName":29,"./utils":33,"_process":1}],21:[function(require,module,exports){
module.exports = {
  "version": "0.23.0"
};
