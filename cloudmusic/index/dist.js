 ...
 * @LastEditTime: 2021-10-17 15:16:41
 * @FilePath: \cloudmusic\data_interface.js
 */
...
async function telephoneRegister(telephone, password) {
    ...
    const res = await axios({
        URL: '/register/cellphone?phone=' + telephone + 'password=' + password
    })
    
}

async function checkCellphone() {
    const res = await axios({
...
console.log(1);
},{"npm/node_modules/axios":3}],3:[function(require,module,exports){
